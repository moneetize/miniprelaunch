  ...
  return (
    <div className="absolute inset-0 h-full w-full overflow-hidden bg-black">
      ...
      <main className="relative z-10 flex h-full items-start justify-center overflow-y-auto px-[15px] pb-12 pt-[64px] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        ...
        >
          <div className="mb-[62px] flex flex-col items-center">
          ...
          {!isSubmitted ? (
            <>
              <div className="mb-[44px] text-center">
                <h1 className="mb-3 text-[22px] font-black leading-none text-white">Reset Password</h1>
                <p className="mx-auto max-w-[292px] text-[13px] font-bold leading-snug text-white/46">
                  Enter the email on your account and we will send instructions to regain access.
                </p>
              </div>
              ...
              >
                ...
                <p className="pt-[34px] text-center text-[13px] font-black text-white/42">
                  Remembered it?{' '}
            ...
            <motion.div
              initial={{ y: 12, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              className="mx-auto w-full max-w-[315px] text-center"
            >
              <div className="mx-auto mb-6 flex h-[74px] w-[74px] items-center justify-center rounded-full border border-[#91ef9a]/24 bg-[#91ef9a]/10">
                <CheckCircle className="h-9 w-9 text-[#91ef9a]" />
              </div>
              <h2 className="mb-3 text-[22px] font-black leading-none text-white">Check Your Email</h2>
              <p className="mb-[58px] text-[13px] font-bold leading-snug text-white/48">
                Password reset instructions were sent to <span className="text-white">{email}</span>.
              </p>
              <button
                onClick={() => navigate('/login')}
                className="mx-auto block h-[54px] min-w-[154px] rounded-full bg-gradient-to-r from-[#91ef9a] to-[#78d9f8] px-7 text-[14px] font-black text-[#061011] shadow-[0_18px_44px_rgba(103,232,249,0.18)] transition-transform hover:scale-[1.02]"
              >
                Back to Login
              </button>
            </motion.div>
